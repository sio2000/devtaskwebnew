...
const techTabsIcons = [
  ...
  [
    ...
    { icon: <SiPaypal className="text-iris-bright text-4xl" />, name: 'PayPal' },
    ...
    <div className="bg-gradient-to-br from-ink via-ink-800 to-ink-800 min-h-screen text-paper font-sans">
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-10" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.12 } } }}>
            {offers.map((o, idx) => (
              <motion.div key={o.title} className="group relative bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 p-8 md:p-10 flex flex-col items-center text-center cursor-pointer transition-all duration-300 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-200 overflow-hidden" initial={{ opacity: 0, y: 40, scale: 0.97 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} whileHover={{ scale: 1.04, y: -8 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: idx * 0.07 }} onMouseEnter={() => playSound(hoverSfx)} onClick={() => playSound(clickSfx)}>
                ...
                />
                <div className="relative z-10 mb-6 flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-iris/20 to-iris/10 shadow-inner group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 border-4 border-iris/30 group-hover:border-purple-300">{o.icon}</div>
                <h4 className="relative z-10 text-xl font-bold text-paper mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300 tracking-tight">{o.title}</h4>
                <p className="relative z-10 text-paper-dim mb-6 text-base leading-relaxed">{o.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative max-w-7xl mx-auto py-24 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.12 } } }}>
            {useCases.map((u, idx) => (
              <motion.div key={u.title} className="group relative bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 p-8 md:p-10 flex flex-col items-center text-center cursor-pointer transition-all duration-300 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-200 overflow-hidden" initial={{ opacity: 0, y: 40, scale: 0.97 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} whileHover={{ scale: 1.04, y: -8 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: idx * 0.07 }} onMouseEnter={() => playSound(hoverSfx)} onClick={() => playSound(clickSfx)}>
                {/* Shine Effect */}
                <motion.div
                  className="absolute inset-0 rounded-3xl bg-gradient-to-r from-transparent via-ink/30 to-transparent opacity-0 group-hover:opacity-100"
                  initial={{ x: '-100%' }}
                  ...
                  transition={{ duration: 0.8 }}
                />
                <div className="relative z-10 mb-6 flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-iris/20 to-iris/10 shadow-inner group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 border-4 border-iris/30 group-hover:border-purple-300">{u.icon}</div>
                <h4 className="relative z-10 text-lg font-bold text-paper mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300 tracking-tight">{u.title}</h4>
                <p className="relative z-10 text-paper-dim mb-6 text-base leading-relaxed">{u.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative max-w-7xl mx-auto py-24 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.12 } } }}>
            {uxFocus.map((u, idx) => (
              <motion.div key={u.title} className="group relative bg-white/[0.045] backdrop-blur-xl rounded-2xl shadow-xl border border-white/10 p-8 flex flex-col items-center text-center cursor-pointer transition-all duration-300 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-200 overflow-hidden" initial={{ opacity: 0, y: 40, scale: 0.97 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} whileHover={{ scale: 1.04, y: -8 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: idx * 0.07 }} onMouseEnter={() => playSound(hoverSfx)} onClick={() => playSound(clickSfx)}>
                {/* Shine Effect */}
                <motion.div
                  className="absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent via-ink/30 to-transparent opacity-0 group-hover:opacity-100"
                  initial={{ x: '-100%' }}
                  ...
                  transition={{ duration: 0.8 }}
                />
                <div className="relative z-10 mb-4 flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-iris/20 to-iris/10 shadow-inner group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 border-4 border-iris/30 group-hover:border-purple-300">{u.icon}</div>
                <h4 className="relative z-10 text-base font-bold text-paper mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300 tracking-tight">{u.title}</h4>
                <p className="relative z-10 text-paper-dim mb-4 text-sm leading-relaxed">{u.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="relative max-w-7xl mx-auto py-24 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="relative flex items-center justify-center">
            <button className="absolute left-0 z-10 p-3 bg-white/[0.045] backdrop-blur-lg rounded-full shadow hover:bg-iris/15 transition-all" onClick={() => setCurrentClient((currentClient - 1 + clients.length) % clients.length)}><FaChevronLeft className="text-blue-500 text-2xl" /></button>
            <motion.div className="group relative w-full max-w-lg mx-auto bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-300 cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-200" key={clients[currentClient].name} initial={{ opacity: 0, y: 50, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.5 }}>
              {/* Shine Effect */}
              <motion.div
                className="absolute inset-0 rounded-3xl bg-gradient-to-r from-transparent via-ink/30 to-transparent opacity-0 group-hover:opacity-100"
                initial={{ x: '-100%' }}
                ...
                transition={{ duration: 0.8 }}
              />
              <div className="relative z-10 h-64 overflow-hidden flex items-center justify-center bg-gradient-to-br from-iris/20 to-iris/10">
                <img src={clients[currentClient].img} alt={clients[currentClient].name} className="w-full h-full object-contain" />
              </div>
              <div className="relative z-10 flex flex-col items-center p-8">
                <h4 className="text-2xl font-bold text-paper mb-2">{clients[currentClient].name}</h4>
                <p className="text-iris-bright text-base mb-2">{clients[currentClient].desc}</p>
            ...
            <button className="absolute right-0 z-10 p-3 bg-white/[0.045] backdrop-blur-lg rounded-full shadow hover:bg-iris/15 transition-all" onClick={() => setCurrentClient((currentClient + 1) % clients.length)}><FaChevronRight className="text-blue-500 text-2xl" /></button>
          </div>
        </div>
      </section>
