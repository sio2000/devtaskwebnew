...
const techStack = [
  ...
  { icon: <SiNextdotjs className="text-paper text-4xl" />, name: 'Next.js' },
  ...
  { icon: <SiVercel className="text-paper text-4xl" />, name: 'Vercel' },
];
    ...
    <div className="bg-gradient-to-br from-ink via-ink-800 to-ink-800 min-h-screen text-paper font-sans">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pb-10 select-none">
        ...
        {!isMobile && (
          <>
            <motion.div className="absolute inset-0 z-0 pointer-events-none">
              <motion.div
                className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-gradient-to-br from-blue-400/50 via-purple-400/40 to-ink/0 rounded-full blur-3xl animate-spin-slow"
                animate={{ rotate: 360 }}
                transition={{ duration: 40, repeat: Infinity, ease: 'linear' }}
              />
              <motion.div
                className="absolute bottom-[-10%] right-[-10%] w-[32vw] h-[32vw] bg-gradient-to-br from-purple-400/50 via-blue-400/40 to-ink/0 rounded-full blur-3xl animate-spin-slow"
                animate={{ rotate: -360 }}
                transition={{ duration: 60, repeat: Infinity, ease: 'linear' }}
              />
              {/* Soft particles */}
              <motion.div
                className="absolute top-1/4 left-1/4 w-64 h-64 bg-white/[0.06] rounded-full blur-3xl"
                animate={{ y: [0, -20, 0], rotate: [0, 5, 0] }}
                transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
              />
              <motion.div
                className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-white/[0.06] rounded-full blur-3xl"
        ...
        <div className="absolute inset-0 w-full h-full z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-ink/80 via-ink-800/80 to-ink-800/80" />
        </div>
        {/* Hero Content */}
        <div className="relative z-20 max-w-3xl mx-auto px-4 py-32 text-center flex flex-col items-center">
          {!isMobile ? (
            <>
              ...
              <motion.p
                className="text-xl md:text-2xl text-paper-dim mb-10 font-medium max-w-2xl mx-auto"
                initial={{ opacity: 0, y: 40 }}
                animate={{ opacity: 1, x: parallax.x, y: parallax.y }}
                transition={{ duration: 0.7, type: 'spring', stiffness: 60, damping: 18 }}
              >
            ...
            <>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-paper-dim mb-10 font-medium max-w-2xl mx-auto px-4 break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                {t.services.pages.webDevelopment.hero.subtitle}
              </p>
            </>
          )}
      ...
      <section className="max-w-5xl mx-auto py-16 px-4 text-center flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="relative bg-white/[0.05] backdrop-blur-lg rounded-3xl shadow-2xl border border-white/10 p-10 flex flex-col items-center w-full md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-extrabold text-paper mb-6 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent drop-shadow-lg">{t.services.pages.webDevelopment.whyUs.title}</h2>
          <p className="text-lg md:text-xl text-paper-dim max-w-2xl mx-auto mb-2">{t.services.pages.webDevelopment.whyUs.description}</p>
          <p className="text-lg md:text-xl text-iris-bright max-w-2xl mx-auto font-semibold">{t.services.pages.webDevelopment.whyUs.fromTo} <span className='bg-gradient-to-r from-iris/25 to-iris/15 px-2 rounded'>{t.services.pages.webDevelopment.whyUs.support}</span>, <span className='bg-gradient-to-r from-iris/20 to-iris/10 px-2 rounded'>{t.services.pages.webDevelopment.whyUs.transparency}</span> και <span className='bg-gradient-to-r from-iris/30 to-iris/20 px-2 rounded'>{t.services.pages.webDevelopment.whyUs.quality}</span>.</p>
        </div>
      </section>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10">
            {t.services.pages.webDevelopment.features.items.map((f: any, idx: number) => {
              ...
              <motion.div
                key={f.title}
                className="group relative bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 p-8 md:p-10 flex flex-col items-center text-center cursor-pointer transition-all duration-300 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-200 overflow-hidden"
                initial={{ opacity: 0, y: 40 }}
              ...
              >
                ...
                />
                <div className="relative z-10 mb-6 flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-iris/20 to-iris/10 shadow-inner border-4 border-iris/30 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">
                  {icons[idx]}
                </div>
                <h4 className="relative z-10 text-xl font-bold text-paper mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300 tracking-tight">
                  {f.title}
                </h4>
                <p className="relative z-10 text-paper-dim mb-6 text-base leading-relaxed">{f.desc}</p>
              </motion.div>
              );
            })}
          </div>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <motion.div
                key={sample.title}
                className="group relative bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 overflow-hidden flex flex-col hover:shadow-2xl transition-all duration-500 cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-200"
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                {/* Shine Effect */}
                <motion.div
                  className="absolute inset-0 rounded-3xl bg-gradient-to-r from-transparent via-ink/30 to-transparent opacity-0 group-hover:opacity-100 z-20"
                  initial={{ x: '-100%' }}
                  whileHover={{ x: '100%' }}
                  transition={{ duration: 0.8 }}
                />
                ...
                <div className="p-6 md:p-8 flex flex-col flex-1 relative z-10">
                  <h4 className="text-xl md:text-2xl font-bold text-paper mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300 tracking-tight">
                    {sample.title}
                  </h4>
                  <p className="text-paper-dim text-base mb-4 flex-1 leading-relaxed">{sample.desc}</p>
                  <a
                    href={s.url}
                    target="_blank"
      ...
      <section className="relative max-w-4xl mx-auto py-24 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 bg-white/[0.045] backdrop-blur-xl rounded-3xl shadow-xl border border-white/10 p-8 md:p-10 flex flex-col items-center gap-10 overflow-hidden hover:shadow-2xl transition-all duration-500">
          {/* Animated Gradient Background on Hover */}
          <motion.div
          ...
          <div className="relative z-10 w-full">
            ...
            <p className="text-lg md:text-xl text-paper-dim mb-10 max-w-xl text-center mx-auto leading-relaxed">{t.services.pages.webDevelopment.process.description}</p>
            {/* Timeline */}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-10">
            {techStack.map((t, idx) => (
              <motion.div
                key={t.name}
                className="group relative flex flex-col items-center gap-2 bg-white/[0.045] backdrop-blur-xl rounded-2xl shadow-xl border border-white/10 p-6 md:p-8 hover:shadow-2xl transition-all duration-300 overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-10">
            {t.services.pages.webDevelopment.stats.items.map((stat: any, idx: number) => {
              ...
              <motion.div
                key={stat.label}
                className="group relative flex flex-col items-center bg-white/[0.045] backdrop-blur-xl rounded-2xl shadow-xl border border-white/10 p-8 md:p-12 hover:shadow-2xl transition-all duration-300 overflow-hidden"
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                whileHover={{ scale: 1.04, y: -8 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.8 }}
                />
                <div className="relative z-10 mb-4 flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-iris/20 to-iris/10 shadow-inner border-4 border-iris/30 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">
                  {s.icon}
                </div>
                <span className="relative z-10 text-4xl md:text-5xl font-extrabold text-iris-bright mb-2 animate-pulse">
                  {s.value}{s.suffix}
                </span>
                <span className="relative z-10 text-paper font-semibold text-base md:text-lg text-center tracking-tight">{stat.label}</span>
              </motion.div>
              );
            })}
          </div>
